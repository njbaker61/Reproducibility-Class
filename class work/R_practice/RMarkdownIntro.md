...
![The Moon-image caption goes here](Moon.jpg) -to move back in
directory: (../folder/jpg) -to move forward in directory: (folder/jpg)

## editing readme files:

same process in github as for images above, with brackets and
parenthesis.
